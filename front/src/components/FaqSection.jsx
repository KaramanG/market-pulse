...
const faqs = [
  {
    ...
    answer: "Графики показывают количество транзакций, средний чек, выручку по клиентам. Данные отображаются по дням."
  },
  {
    question: "По какому критерию формируется график с данными конкурентов?",
    answer: "Данные конкурентов формируются на основе обезличенной и агрегированной статистики по схожим видам деятельности в вашем регионе."
  },
  {
    question: "За какой период можно посмотреть данные?",
    answer: "Вы можете просматривать данные за последнюю неделю, месяц или выбрать конкретный период в календаре."
  },
  {
    question: "Сервис показывает весь рынок или только его часть?",
    answer: "Сервис анализирует репрезентативную выборку рынка, достаточную для построения точных прогнозов и анализа тенденций."
  }
];
